...
void LCD_Clear_jet(u16 x, u16 y, u16 Color)
{
	u16 i,j;  	
	LCD_Address_Set(x,y-5,x+10,y+5);
	for(i=x;i<x+11;i++)
	{
		for (j=y-5;j<y+6;j++)
		{
...
void Draw_Circle(u16 x0,u16 y0,u8 r,u16 color)
{
	...
	// while(a<=b)
	// {
		LCD_DrawPoint(x0,y0,color);             //3   
		LCD_DrawPoint(x0+1,y0,color);         
		LCD_DrawPoint(x0+2,y0,color);
		LCD_DrawPoint(x0+3,y0,color);
		LCD_DrawPoint(x0+4,y0,color);
		LCD_DrawPoint(x0+5,y0,color);
		LCD_DrawPoint(x0+6,y0,color);
		LCD_DrawPoint(x0+7,y0,color);
		LCD_DrawPoint(x0+8,y0,color);
		LCD_DrawPoint(x0+9,y0,color);

		LCD_DrawPoint(x0,y0-1,color);             //3   
		LCD_DrawPoint(x0+1,y0-1,color);         
		LCD_DrawPoint(x0+2,y0-1,color);
		LCD_DrawPoint(x0+3,y0-1,color);
		LCD_DrawPoint(x0+4,y0-1,color);
		LCD_DrawPoint(x0+5,y0-1,color);
		LCD_DrawPoint(x0+6,y0-1,color);
		LCD_DrawPoint(x0+7,y0-1,color);
		LCD_DrawPoint(x0+8,y0-1,color);
		// LCD_DrawPoint(x0+9,y0,color);

		// LCD_DrawPoint(x0-1,y0,color); 
		// LCD_DrawPoint(x0-1,y0+1,color);         
		// LCD_DrawPoint(x0-1,y0+2,color);
		// LCD_DrawPoint(x0-1,y0+3,color);
		// LCD_DrawPoint(x0-1,y0+4,color);
		// LCD_DrawPoint(x0-1,y0+5,color);
		// // LCD_DrawPoint(x0-1,y0+6,color);
		...
		LCD_DrawPoint(x0,y0-2,color);             //3   
		LCD_DrawPoint(x0+1,y0-2,color);         
		LCD_DrawPoint(x0+2,y0-2,color);
		LCD_DrawPoint(x0+3,y0-2,color);
		LCD_DrawPoint(x0+4,y0-2,color);
		LCD_DrawPoint(x0+5,y0-2,color);
		LCD_DrawPoint(x0+6,y0-2,color);
		LCD_DrawPoint(x0+7,y0-2,color);
		...
		LCD_DrawPoint(x0+2,y0+3,color);
		LCD_DrawPoint(x0+2,y0+4,color);
		LCD_DrawPoint(x0+2,y0+5,color);
		LCD_DrawPoint(x0+3,y0+3,color);
		LCD_DrawPoint(x0+3,y0+4,color);
		LCD_DrawPoint(x0+4,y0+3,color);
...
void Draw_Circle1(u16 x0,u16 y0,u8 r,u16 color)
{
	...
	// {
		...
		LCD_DrawPoint(x0+6,y0-2,color);
		LCD_DrawPoint(x0+7,y0-2,color);
		LCD_DrawPoint(x0+8,y0-2,color);
		LCD_DrawPoint(x0+9,y0-2,color);
		...
		LCD_DrawPoint(x0+7,y0+3,color);
		LCD_DrawPoint(x0+7,y0+4,color);
		LCD_DrawPoint(x0+7,y0+5,color);
		LCD_DrawPoint(x0+6,y0+3,color);
		LCD_DrawPoint(x0+6,y0+4,color);
		LCD_DrawPoint(x0+5,y0+3,color);
